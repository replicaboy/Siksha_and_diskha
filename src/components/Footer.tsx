      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/courses/academic" className="hover:text-white transition-colors">
                  Academic Classes
                </Link>
              </li>
              <li>
                <Link href="/courses/english" className="hover:text-white transition-colors">
                  English Courses
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/courses/polytechnic" className="hover:text-white transition-colors">
                  Polytechnic
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span>Banuali, Darbhanga, Bihar - 847428</span>
              </li>
              <li>
                <a href="tel:+919304641843" className="hover:text-white transition-colors flex items-center">
              ...
              <li>
                <a href="mailto:sikshaanddikshaclasses@gmail.com" className="hover:text-white transition-colors flex items-center">
                  <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>&copy; {currentYear} Siksha And Diksha Classes. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
